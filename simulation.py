...
if __name__ == "__main__":
    ...
    # single_charge_with_communication = SingleChargerSim().single_charger_simulation_with_communication(40).\
    #     run_analytics_on_simulation()
    multi_with_communication = MultiChargerSim().multi_charger_simulation_experimental_with_communication(40).\
        run_analytics_on_simulation()
